...
<title>Corporate Event Planning</title>
</head>
<body>
...
<!----------------------------------------------------------------------------------------------------------------------------------------->
    <div class="middle">
    <div class="middle">
      <form action="AddEventServlet" method = "POST" class="full_wedding">
        <h3>Corporate Event Planning</h3>

		<label for="cparty">Event Date :</label>
        <input type="date" id="wed_day" name="edate" class="inputarea"> <br><br><br>


        <label for="venue">Event Type &nbsp &nbsp  :</label>

          <select name = "etype" class="inputarea">
          ...
          <p style="font-size: small;">*If you selecting other option pleace mention some details about the event in the description box bellow</p>
          <br>
          ...
          <input type="number" name="pax_count" class="inputarea"><br><br>
